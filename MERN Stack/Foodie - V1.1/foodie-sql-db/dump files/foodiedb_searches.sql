...
CREATE TABLE `searches` (
  ...
  `searchQuery` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `datetime` datetime NOT NULL,
  PRIMARY KEY (`idSearch`),
  KEY `searchByAccount_idx` (`idAccount`),
  CONSTRAINT `searchByAccount` FOREIGN KEY (`idAccount`) REFERENCES `accounts` (`idAccount`)
) ENGINE=InnoDB AUTO_INCREMENT=995 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
